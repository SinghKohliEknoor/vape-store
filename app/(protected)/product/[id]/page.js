...
//       <div className="pt-35 px-8 flex items-center justify-center">
...
//               {product.name}
//             </h1>
//             <p className="text-yellow-400 text-2xl font-semibold mb-4">
//               ${product.price}
//             </p>
    ...
    <div className="flex flex-col min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white">
      ...
      <main className="flex-grow flex items-center justify-center px-8">
        <div className="w-full max-w-6xl grid grid-cols-1 lg:grid-cols-2 gap-10">
          {/* Image */}
          <div className="bg-gradient-to-br from-gray-800 to-gray-900 backdrop-blur-md border border-white/20 rounded-xl shadow-lg p-6 flex items-center justify-center">
            <Image
              src={product.image_url}
              alt={product.name}
              width={400}
          ...
          <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-xl shadow-lg p-8">
            ...
            <div className="flex gap-4">
              <button
                onClick={addToCart}
                disabled={addingToCart}
                className={`px-6 py-2 rounded-md font-medium text-black transition ${
                  addingToCart
                    ? "bg-yellow-200 cursor-not-allowed"
                    : "bg-yellow-300 hover:bg-yellow-400"
                }`}
              ...
              <button
                onClick={addToWishlist}
                disabled={addingToWishlist}
                className={`flex items-center gap-2 px-6 py-2 rounded-md border text-yellow-300 transition ${
                  addingToWishlist
                    ? "border-yellow-100 cursor-not-allowed"
                    : "border-yellow-400 hover:bg-white/10"
                }`}
