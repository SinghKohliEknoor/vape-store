    ...
    <section className="bg-white py-16 px-4 sm:px-6 lg:px-8 border-t border-gray-200">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Quality Products */}
          <div className="bg-white p-8 rounded-xl border border-gray-200 shadow-sm hover:shadow-lg transition-all flex flex-col items-center text-center">
          ...
          <div className="bg-white p-8 rounded-xl border border-gray-200 shadow-sm hover:shadow-lg transition-all flex flex-col items-center text-center">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">WORLD-CLASS SUPPORT</h3>
            <p className="text-gray-600">
          ...
          <div className="bg-white p-8 rounded-xl border border-gray-200 shadow-sm hover:shadow-lg transition-all flex flex-col items-center text-center">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">100% SATISFACTION</h3>
            <p className="text-gray-600">
